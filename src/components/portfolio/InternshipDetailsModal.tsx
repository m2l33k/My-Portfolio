        ...
        <ScrollArea className="flex-1 p-6">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-semibold text-foreground">{t("internships.overview")}</h4>
            ...
            {internship.technologies && internship.technologies.length > 0 && (
              <div className="space-y-3">
                <h4 className="text-lg font-semibold text-foreground">{t("internships.technologies")}</h4>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              {internship.companyUrl && (
                <Button onClick={() => window.open(internship.companyUrl, "_blank")} className="gap-2">
                  <ExternalLink className="h-4 w-4" />
                  {t("internships.visitCompany")}
                </Button>
              )}
